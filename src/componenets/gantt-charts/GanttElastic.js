...
function getDate(hours) {
  return dayjs().startOf('day').valueOf() + hours * 60 * 60 * 1000;
}

function GanttChartElastic() {
  const tasks = [
    {
      id: 1,
...
export default GanttChartElastic;
...
// // );
// import React from 'react';
// // import 'gantt-elastic/dist/gantt.css';
// import GanttElastic from 'gantt-elastic';

// const GanttChartElastic = () => {
//   const tasks = [
//     {
//       id: '1',
//       name: 'Task 1',
